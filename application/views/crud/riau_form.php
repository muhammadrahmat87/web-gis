...
<tr><th>NPWPD</th><td><input type="number" name="nip" value="<?= $nip ?>" class="form-control" required=""></td></tr>
<tr><th>Kode</th><td><input type="text" name="nama" value="<?= $nama ?>" class="form-control" required=""></td></tr>
<tr><th>Nama Usaha</th><td><input type="text" name="">n</td></tr>
